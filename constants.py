# --- Standard Library ---
import os
from utils import load_message_from_file
...
SCRIPTS_DIR = os.path.join(BASE_DIR, "scripts")  # Directory for scripts
TEMPLATES_DIR = os.path.join(SCRIPTS_DIR, "templates")  # Directory for templates
...
SYSTEM_MESSAGE_TEMPLATE_FILE = os.path.join(TEMPLATES_DIR, "system_message.template.txt")  # Template for system message
WELCOME_MESSAGE_TEMPLATE_FILE = os.path.join(TEMPLATES_DIR, "welcome_message.template.txt")  # Template for welcome message   
...
# Load messages
SYSTEM_MESSAGE = load_message_from_file(SYSTEM_MESSAGE_TEMPLATE_FILE)
WELCOME_MESSAGE = load_message_from_file(WELCOME_MESSAGE_TEMPLATE_FILE)